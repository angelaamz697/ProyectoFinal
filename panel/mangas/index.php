  ...
  <body>
    ...
    <div class="container" id="main">
        ...
        <div class="row">
          <div class="col-md-12">
             <fieldset>
              <legend>Listado de Mangas</legend>
                <table class="table table-bordered">
                  ...
                  <tbody> 
                    <?php
                      ...
                      $info_manga = $manga->mostrar();
                    
                      
                      $cantidad = count($info_manga);
                      //cuando la cantidad de mangas sea mayor que 0 se ejecute
                      if($cantidad > 0){
                        $c=0;
                      
                      for($x =0; $x < $cantidad; $x++){
                        $c++;
                        $item = $info_manga[$x]; //almacena cada aaray del bucle
                    ?>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <?php
                          $foto = '../../upload/'.$item['foto']; //la foto
                          if(file_exists($foto)){  //si existe foto le ponemos un ancho y si no hay que muestre el mensaje
                        ?>
                          <img src="<?php print $foto; ?>" width="60">
                      <?php }else{?>
                          No se puede visualizar la foto 
                      <?php }?>
                      </td>
                      <td class="text-center">
