...
<?php
  ...
  if(isset($_GET['id']) && is_numeric($_GET['id'])){ //si existe y  es numérico este valor
      $id = $_GET['id'];
    
      $manga = new angelamunoz\Manga;
      $resultado = $manga->mostrarPorId($id); //mostramos por el id

      if(!$resultado)//si no hay registro que tambien lo redireccione al index
          header('Location: index.php');

  }else{ //sino que lo redireccione al index
    header('Location: index.php');
  }
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav pull-right">
            ...
            <li class="active">
              <a href="index.php" class="btn">Mangas</a>
            </li>
            <li class="dropdown">
    ...
    <div class="container" id="main">
      <div class="row">
        <div class="col-md-12">
          <fieldset>
            <legend>Datos del Manga</legend>
            <form method="POST" action="../acciones.php" enctype="multipart/form-data" >
              <input type="hidden" name="id" value="<?php print $resultado['id'] ?>">
              <!-- campo hidden para que no muestre del id -->
              <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-4">
                      <div class="form-group">
                          ...
                          <select class="form-control" name="categoria_id" required>
                            ...
                            <?php
                             require '../../vendor/autoload.php';
                              $categoria = new angelamunoz\Categoria;
